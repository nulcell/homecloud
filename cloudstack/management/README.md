...
- **Naming conventions**:
  ...
  - **feature**:
    - `virtual-router` - Single Virtual Router
    - `redundant-virtual-router` - Redundant Virtual Router
    - `redundant-virtual-router-internal-lb-vm` - Redundant Virtual Router with Internal LB VM
    - `virtual-router-cloud-drive` - Single Virtual Router with Cloud-Drive for DHCP/DNS/Userdata
    - `redundant-virtual-router-cloud-drive` - Redundant Virtual Router with Cloud-Drive for DHCP/DNS/Userdata

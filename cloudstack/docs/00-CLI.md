...
cmk -p admin create serviceoffering name="acs.comp.gen.tiny"      displaytext="General Purpose Tiny with Custom Disk"        customized=false cpunumber=1  cpuspeed=1000 memory=512   networkrate=500  offerha=true  dynamicscalingenabled=true limitcpuuse=true isvolatile=false deploymentplanner="UserDispersingPlanner" ispublic=true purgeresources=true diskofferingstrictness=true diskofferingid=$ACS_DISK_SHARED_CUSTOM_ID
cmk -p admin create serviceoffering name="acs.comp.gen.small"     displaytext="General Purpose Small with Custom Disk"       customized=false cpunumber=1  cpuspeed=2500 memory=1024  networkrate=750  offerha=true  dynamicscalingenabled=true limitcpuuse=true isvolatile=false deploymentplanner="UserDispersingPlanner" ispublic=true purgeresources=true diskofferingstrictness=true diskofferingid=$ACS_DISK_SHARED_CUSTOM_ID
cmk -p admin create serviceoffering name="acs.comp.gen.medium"    displaytext="General Purpose Medium with Custom Disk"      customized=false cpunumber=2  cpuspeed=2500 memory=2048  networkrate=750  offerha=true  dynamicscalingenabled=true limitcpuuse=true isvolatile=false deploymentplanner="UserDispersingPlanner" ispublic=true purgeresources=true diskofferingstrictness=true diskofferingid=$ACS_DISK_SHARED_CUSTOM_ID
cmk -p admin create serviceoffering name="acs.comp.gen.large"     displaytext="General Purpose Large with Custom Disk"       customized=false cpunumber=4  cpuspeed=2500 memory=4096  networkrate=1024 offerha=true  dynamicscalingenabled=true limitcpuuse=true isvolatile=false deploymentplanner="UserDispersingPlanner" ispublic=true purgeresources=true diskofferingstrictness=true diskofferingid=$ACS_DISK_SHARED_CUSTOM_ID
cmk -p admin create serviceoffering name="acs.comp.gen.xlarge"    displaytext="General Purpose xLarge with Custom Disk"      customized=false cpunumber=8  cpuspeed=2500 memory=8192  networkrate=1024 offerha=true  dynamicscalingenabled=true limitcpuuse=true isvolatile=false deploymentplanner="UserDispersingPlanner" ispublic=true purgeresources=true diskofferingstrictness=true diskofferingid=$ACS_DISK_SHARED_CUSTOM_ID
cmk -p admin create serviceoffering name="acs.comp.gen.1_5xlarge" displaytext="General Purpose 1.5xLarge with Custom Disk"   customized=false cpunumber=12 cpuspeed=2500 memory=12288 networkrate=1024 offerha=true  dynamicscalingenabled=true limitcpuuse=true isvolatile=false deploymentplanner="UserDispersingPlanner" ispublic=true purgeresources=true diskofferingstrictness=true diskofferingid=$ACS_DISK_SHARED_CUSTOM_ID
cmk -p admin create serviceoffering name="acs.comp.gen.2xlarge"   displaytext="General Purpose 2xLarge with Custom Disk"     customized=false cpunumber=16 cpuspeed=2500 memory=16384 networkrate=1024 offerha=true  dynamicscalingenabled=true limitcpuuse=true isvolatile=false deploymentplanner="UserDispersingPlanner" ispublic=true purgeresources=true diskofferingstrictness=true diskofferingid=$ACS_DISK_SHARED_CUSTOM_ID
cmk -p admin create serviceoffering name="acs.comp.mem.tiny"      displaytext="Memory Optimized Tiny with Custom Disk"       customized=false cpunumber=1  cpuspeed=1000 memory=1024  networkrate=750  offerha=true  dynamicscalingenabled=true limitcpuuse=true isvolatile=false deploymentplanner="UserDispersingPlanner" ispublic=true purgeresources=true diskofferingstrictness=true diskofferingid=$ACS_DISK_SHARED_CUSTOM_ID
cmk -p admin create serviceoffering name="acs.comp.mem.small"     displaytext="Memory Optimized Small with Custom Disk"      customized=false cpunumber=1  cpuspeed=2500 memory=2048  networkrate=750  offerha=true  dynamicscalingenabled=true limitcpuuse=true isvolatile=false deploymentplanner="UserDispersingPlanner" ispublic=true purgeresources=true diskofferingstrictness=true diskofferingid=$ACS_DISK_SHARED_CUSTOM_ID
cmk -p admin create serviceoffering name="acs.comp.mem.medium"    displaytext="Memory Optimized Medium with Custom Disk"     customized=false cpunumber=2  cpuspeed=2500 memory=4096  networkrate=750  offerha=true  dynamicscalingenabled=true limitcpuuse=true isvolatile=false deploymentplanner="UserDispersingPlanner" ispublic=true purgeresources=true diskofferingstrictness=true diskofferingid=$ACS_DISK_SHARED_CUSTOM_ID
cmk -p admin create serviceoffering name="acs.comp.mem.large"     displaytext="Memory Optimized Large with Custom Disk"      customized=false cpunumber=4  cpuspeed=2500 memory=8192  networkrate=1024 offerha=true  dynamicscalingenabled=true limitcpuuse=true isvolatile=false deploymentplanner="UserDispersingPlanner" ispublic=true purgeresources=true diskofferingstrictness=true diskofferingid=$ACS_DISK_SHARED_CUSTOM_ID
cmk -p admin create serviceoffering name="acs.comp.mem.xlarge"    displaytext="Memory Optimized xLarge with Custom Disk"     customized=false cpunumber=8  cpuspeed=2500 memory=16384 networkrate=1024 offerha=true  dynamicscalingenabled=true limitcpuuse=true isvolatile=false deploymentplanner="UserDispersingPlanner" ispublic=true purgeresources=true diskofferingstrictness=true diskofferingid=$ACS_DISK_SHARED_CUSTOM_ID
cmk -p admin create serviceoffering name="acs.comp.mem.1_5xlarge" displaytext="Memory Optimized 1.5xLarge with Custom Disk"  customized=false cpunumber=12 cpuspeed=2500 memory=24576 networkrate=1024 offerha=true  dynamicscalingenabled=true limitcpuuse=true isvolatile=false deploymentplanner="UserDispersingPlanner" ispublic=true purgeresources=true diskofferingstrictness=true diskofferingid=$ACS_DISK_SHARED_CUSTOM_ID
cmk -p admin create serviceoffering name="acs.comp.mem.2xlarge"   displaytext="Memory Optimized 2xLarge with Custom Disk"    customized=false cpunumber=16 cpuspeed=2500 memory=32768 networkrate=1024 offerha=true  dynamicscalingenabled=true limitcpuuse=true isvolatile=false deploymentplanner="UserDispersingPlanner" ispublic=true purgeresources=true diskofferingstrictness=true diskofferingid=$ACS_DISK_SHARED_CUSTOM_ID
cmk -p admin create serviceoffering name="acs.comp.ssd.tiny"      displaytext="Storage Optimized Tiny with Custom Disk"      customized=false cpunumber=1  cpuspeed=1000 memory=512   networkrate=500  offerha=false dynamicscalingenabled=true limitcpuuse=true isvolatile=false deploymentplanner="UserDispersingPlanner" ispublic=true purgeresources=true diskofferingstrictness=true diskofferingid=$ACS_DISK_LOCAL_CUSTOM_ID
cmk -p admin create serviceoffering name="acs.comp.ssd.small"     displaytext="Storage Optimized Small with Custom Disk"     customized=false cpunumber=1  cpuspeed=2500 memory=1024  networkrate=750  offerha=false dynamicscalingenabled=true limitcpuuse=true isvolatile=false deploymentplanner="UserDispersingPlanner" ispublic=true purgeresources=true diskofferingstrictness=true diskofferingid=$ACS_DISK_LOCAL_CUSTOM_ID
cmk -p admin create serviceoffering name="acs.comp.ssd.medium"    displaytext="Storage Optimized Medium with Custom Disk"    customized=false cpunumber=2  cpuspeed=2500 memory=2048  networkrate=750  offerha=false dynamicscalingenabled=true limitcpuuse=true isvolatile=false deploymentplanner="UserDispersingPlanner" ispublic=true purgeresources=true diskofferingstrictness=true diskofferingid=$ACS_DISK_LOCAL_CUSTOM_ID
cmk -p admin create serviceoffering name="acs.comp.ssd.large"     displaytext="Storage Optimized Large with Custom Disk"     customized=false cpunumber=4  cpuspeed=2500 memory=4096  networkrate=1024 offerha=false dynamicscalingenabled=true limitcpuuse=true isvolatile=false deploymentplanner="UserDispersingPlanner" ispublic=true purgeresources=true diskofferingstrictness=true diskofferingid=$ACS_DISK_LOCAL_CUSTOM_ID
cmk -p admin create serviceoffering name="acs.comp.ssd.xlarge"    displaytext="Storage Optimized xLarge with Custom Disk"    customized=false cpunumber=8  cpuspeed=2500 memory=8192  networkrate=1024 offerha=false dynamicscalingenabled=true limitcpuuse=true isvolatile=false deploymentplanner="UserDispersingPlanner" ispublic=true purgeresources=true diskofferingstrictness=true diskofferingid=$ACS_DISK_LOCAL_CUSTOM_ID
cmk -p admin create serviceoffering name="acs.comp.ssd.1_5xlarge" displaytext="Storage Optimized 1.5xLarge with Custom Disk" customized=false cpunumber=12 cpuspeed=2500 memory=12288 networkrate=1024 offerha=false dynamicscalingenabled=true limitcpuuse=true isvolatile=false deploymentplanner="UserDispersingPlanner" ispublic=true purgeresources=true diskofferingstrictness=true diskofferingid=$ACS_DISK_LOCAL_CUSTOM_ID
cmk -p admin create serviceoffering name="acs.comp.ssd.2xlarge"   displaytext="Storage Optimized 2xLarge with Custom Disk"   customized=false cpunumber=16 cpuspeed=2500 memory=16384 networkrate=1024 offerha=false dynamicscalingenabled=true limitcpuuse=true isvolatile=false deploymentplanner="UserDispersingPlanner" ispublic=true purgeresources=true diskofferingstrictness=true diskofferingid=$ACS_DISK_LOCAL_CUSTOM_ID

# Custom Compute offerings and Custom Storage Disks
cmk -p admin create serviceoffering name="acs.comp.custom.shared" displaytext="Custom Compute with Shared Custom Disk" customized=true cpuspeed=2500 mincpunumber=1 maxcpunumber=16 minmemory=1024 maxmemory=32768 networkrate=1024 offerha=true  dynamicscalingenabled=true limitcpuuse=true isvolatile=false deploymentplanner="UserDispersingPlanner" ispublic=true purgeresources=true customized=true diskofferingstrictness=true diskofferingid=$ACS_DISK_SHARED_CUSTOM_ID
cmk -p admin create serviceoffering name="acs.comp.custom.local"  displaytext="Custom Compute with Local Custom Disk"  customized=true cpuspeed=2500 mincpunumber=1 maxcpunumber=16 minmemory=1024 maxmemory=32768 networkrate=1024 offerha=false dynamicscalingenabled=true limitcpuuse=true isvolatile=false deploymentplanner="UserDispersingPlanner" ispublic=true purgeresources=true customized=true diskofferingstrictness=true diskofferingid=$ACS_DISK_LOCAL_CUSTOM_ID
```
...
CKS_SERVICE_OFFERING_ID_WORKER=$(cmk -p homecloud-admin list serviceofferings name="acs.comp.mem.medium" | jq -r '.serviceoffering[0].id')
